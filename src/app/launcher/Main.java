...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        world.add(new Sphere(new Vec3(0.0f, 0.0f, -1.3f), 0.5f, diffuse(0.1f, 0.2f, 0.5f)));
        world.add(new Sphere(new Vec3(-1.2f, 0.0f, -1.8f), 0.45f, diffuse(0.1f, 0.2f, 0.5f)));
        world.add(new Sphere(new Vec3(-1.0f, 0.0f, -1.0f), 0.5f, dielectric(1.0f / 1.33f)));
        world.add(new Sphere(new Vec3(0.2f, 0.9f, -1.5f), 0.5f, metal(0.8f, 0.4f, 0.4f, 0.08f)));
        render.render(world);
        while (!render.isDone()) {}
